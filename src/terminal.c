...
menu_t menu[] = {
    ...
    /*25*/ {.id = "kU0", .name = "коэф. U петли", .izm = "", .val = 1523, .min = 1, .max = 1000000},
    ...
    /*31*/ {.id = "kUbat", .name = "коэф. U bat", .izm = "", .val = 4088, .min = 1, .max = 1000000},
